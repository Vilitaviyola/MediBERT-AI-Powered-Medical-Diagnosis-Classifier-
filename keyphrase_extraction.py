...
def load_model_and_resources():
    model = BertForSequenceClassification.from_pretrained(r"D:\health\myenv\train\medical_diagnosis_bert_model")
    tokenizer = BertTokenizer.from_pretrained(r"D:\health\myenv\train\medical_diagnosis_bert_model")
    label_encoder = joblib.load(r"D:\health\myenv\train\label_encoder.pkl")
...
@st.cache_resource
def get_keywords():
    return joblib.load(r"D:\health\myenv\train\microscopic_keywords.pkl")
